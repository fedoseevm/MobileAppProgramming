...
public class SmallFilmActivity extends AppCompatActivity {
    VideoView videoView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView.setOnErrorListener((mp, what, extra) -> {
            ...
            Toast.makeText(SmallFilmActivity.this, "Video playback error: what=" + what + ", extra=" + extra, Toast.LENGTH_SHORT).show();
            return true;
        });
    }
}