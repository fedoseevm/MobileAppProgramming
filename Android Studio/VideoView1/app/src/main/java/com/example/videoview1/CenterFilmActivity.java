...
public class CenterFilmActivity extends AppCompatActivity {
    VideoView videoView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView.setOnErrorListener((mp, what, extra) -> {
            ...
            Toast.makeText(CenterFilmActivity.this, "Video playback error: what=" + what + ", extra=" + extra, Toast.LENGTH_SHORT).show();
            return true;
        });
    }
}